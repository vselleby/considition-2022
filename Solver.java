...
public class Solver {
    private static final Double[]  bagType_price         = {1.7, 1.75, 6, 25, 200};
    private static final int[] bagType_co2_production    = {5, 7, 3, 6, 20};
    private static final Integer[] bagType_co2_transport = {50, 40, 60, 70, 100};
